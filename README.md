...
|---|---|---|---|
| **Dravvy** | Browser-only resume builder with real-time preview and PDF/DOCX export | Next.js, Zustand, react-pdf | [Repo](https://github.com/nshizirunguwilson/Dravvy) · [Live](https://dravvy.wilsonn.tech) |
| **Umwuga** | Professional services marketplace with payments and job matching | NestJS, PostgreSQL, Redis, BullMQ | Private |
| **Markova** | School management platform with web dashboard | Next.js, NestJS | Private |
| **Meza POS** | Tableside ordering app for restaurants and cafes | Expo, Zustand | Private |
